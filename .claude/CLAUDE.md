...
**Рабочий процесс:** ближайший этап — детальная проработка формата конфигурационного файла и аргументов командной строки. Каждый аспект оформляется отдельным файлом-спецификацией в этой директории.
